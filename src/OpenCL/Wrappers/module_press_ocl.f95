...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: press_rhsav_ocl_exectime
        ! integer :: srclen, klen
...
#error "Value for KERNEL not supported!"
    ...
    call runOcl(press_rhsav_ocl_globalrange,press_rhsav_ocl_localrange,press_rhsav_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: press_sor_ocl_exectime
        ! integer :: srclen, klen
...
!        print *,"SOR nrd (host): ",nrd
    ...
    call runOcl(press_sor_ocl_globalrange,press_sor_ocl_localrange,press_sor_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: press_pav_ocl_exectime
        ! integer :: srclen, klen
...
#error "Value for KERNEL not supported!"
    ...
    call runOcl(press_pav_ocl_globalrange,press_pav_ocl_localrange,press_pav_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: press_adj_ocl_exectime
        ! integer :: srclen, klen
...
!
    ...
    call runOcl(press_adj_ocl_globalrange,press_adj_ocl_localrange,press_adj_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: press_boundp_ocl_exectime
        ! integer :: srclen, klen
...
!
    ...
    call runOcl(press_boundp_ocl_globalrange,press_boundp_ocl_localrange,press_boundp_ocl_exectime)
