...
!        integer, dimension(1) :: n_ptr
        ...
        real(kind=4) :: bondv1_ocl_exectime
        ! integer :: srclen, klen
...
!        n_ptr(1)=n
        ...
        call runOcl(bondv1_ocl_globalrange,bondv1_ocl_localrange,bondv1_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: bondv1_calc_uout_ocl_exectime
        ! integer :: srclen, klen
...
!        n_ptr(1)=n
        ...
        call runOcl(bondv1_calc_uout_ocl_globalrange,bondv1_calc_uout_ocl_localrange,bondv1_calc_uout_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: bondv1_calc_uvw_ocl_exectime
        ! integer :: srclen, klen
 ...
 ! Convert to new format
        ...
        call runOcl(bondv1_calc_uvw_ocl_globalrange,bondv1_calc_uvw_ocl_localrange,bondv1_calc_uvw_ocl_exectime)
