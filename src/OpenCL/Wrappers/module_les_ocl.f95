...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: bondv1_calc_uvw__velfg__feedbf__les_calc_sm_ocl_exectime
        ! integer :: srclen, klen
 ...
 ! Convert to new format
        ...
        call runOcl(bondv1_calc_uvw__velfg__feedbf__les_calc_sm_ocl_globalrange,bondv1_calc_uvw__velfg__feedbf__les_calc_sm_ocl_localrange,bondv1_calc_uvw__velfg__feedbf__les_calc_sm_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: merged_velfg_feedbf_les_calc_sm_ocl_exectime
        ! integer :: srclen, klen
 ...
 ! Convert to new format
    ...
    call runOcl(merged_velfg_feedbf_les_calc_sm_ocl_globalrange,merged_velfg_feedbf_les_calc_sm_ocl_localrange,merged_velfg_feedbf_les_calc_sm_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: les_calc_sm_ocl_exectime
        ! integer :: srclen, klen
...
! diu in, sm in/out (sm needs to be read in once, in init), fgh in
    ...
    call runOcl(les_calc_sm_ocl_globalrange,les_calc_sm_ocl_localrange,les_calc_sm_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: les_bound_sm_ocl_exectime
        ! integer :: srclen, klen
...
! sm in and out, which means it can stay on the device unless we do this calc locally
    ...
    ! call les_bound_sm(fgh,dx1,dy1,dzn,diu,sm,im,jm,km)
    call runOcl(les_bound_sm_ocl_globalrange,les_bound_sm_ocl_localrange,les_bound_sm_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: les_calc_visc_ocl_exectime
        ! integer :: srclen, klen
...
! diu, sm and fgh in, fgh out, so here I need to read back fgh for sure, maybe also sm, for avesm
    ...
    ! call les_calc_visc(fgh,dx1,dy1,dzn,diu,sm,im,jm,km)
    call runOcl(les_calc_visc_ocl_globalrange,les_calc_visc_ocl_localrange,les_calc_visc_ocl_exectime)
...
! Combined arrays for OpenCL kernel
        ...
        real(kind=4) :: les_calc_visc__adam_ocl_exectime
        ! integer :: srclen, klen
...
! diu, sm and fgh in, fgh out, so here I need to read back fgh for sure, maybe also sm, for avesm
    ...
    call runOcl(les_calc_visc__adam_ocl_globalrange,les_calc_visc__adam_ocl_localrange,les_calc_visc__adam_ocl_exectime)
