...
#ifdef TIMINGS
        real (kind=4), dimension(0:11) :: timestamp
        real (kind=4) :: time_start_main, time_after_setup, time_stop_main
        call cpu_time(time_start_main)
#else
...
#ifdef TIMINGS
    nmax=21
    call cpu_time(time_after_setup)
    print *,"Setup time:" ,time_after_setup-time_start_main,"s"
#else
    nmax=200
#endif
...
#ifdef TIMINGS
    call cpu_time(time_stop_main)
    print *,"Total time:" ,time_stop_main-time_after_setup,"s for ",nmax-n0,"iterations"
    print *,"Total time with setup:" ,time_stop_main-time_start_main,"s for ",nmax-n0,"iterations"
#endif
!
